/*!
  ...
  * Build: ender build jeesh /Users/jergason/abc_home1/tolmey/
  * =============================================================
  */
...
/*!
  ...
  * License MIT
  */
!function(a){function d(a){var c=b[a]||window[a];if(!c)throw new Error("Requested module '"+a+"' has not been defined.");return c}function e(a,c){return b[a]=c}function f(a,b){for(var c in b)c!="noConflict"&&c!="_VERSION"&&(a[c]=b[c]);return a}function g(a,b,c){return typeof a=="string"||a.nodeName||a.length&&"item"in a||a==window?(c=h._select(a,b),c.selector=a):c=isFinite(a.length)?a:[a],f(c,g)}function h(a,b){return g(a,b)}a.global=a;var b={},c=a.$;a.provide=e,a.require=d,f(h,{_VERSION:"0.3.6",fn:g,ender:function(a,b){f(b?g:h,a)},_select:function(a,b){return(b||document).querySelectorAll(a)}}),f(g,{forEach:function(a,b,c){for(c=0,l=this.length;c<l;++c)c in this&&a.call(b||this[c],this[c],c,this);return this},$:h}),h.noConflict=function(){return a.$=c,this},typeof module!="undefined"&&module.exports&&(module.exports=h),a.ender=a.$=a.ender||h}(this),!function(){var a={exports:{}},b=a.exports;(function(){function b(){this.RADIUS_OF_EARTH_IN_METERS=6367560,this.TILESIZE=256}"use strict",b.prototype.haversineFunction=function(a,b,c,d){return 2*Math.asine(Math.sqrt(Math.pow(Math.sin((c-a)/2),2)+Math.cos(a)*Math.cos(c)*Math.pow(Math.sin((d-b)/2),2)))},b.prototype.distanceInMeters=function(a,b,c,d){var e=this.haversineFunction(a,d,c,d);return e*this.RADIUS_OF_EARTH_IN_METERS},b.prototype.getMercatorFromGPS=function(a,b,c){var d=this.lonToXPixels(c,this.degreesToRadians(b)),e=this.latToYPixels(c,this.degreesToRadians(a)),f=Math.pow(2,c)*this.TILESIZE;d<0?d+=f:d>f&&(d-=f);var g=Math.floor(d/this.TILESIZE),h=Math.floor(e/this.TILESIZE);return g>=Math.pow(2,c)&&(g-=Math.pow(2,c)),{x:g,y:h}},b.prototype.getTileURL=function(a,b,c,d){if(a==="openstreetmap")return"http://tile.openstreetmap.org/"+d+"/"+b+"/"+c+".png"},b.prototype.latToYPixels=function(a,b){var c=this.atanh(Math.sin(b)),d=-(c*this.TILESIZE*Math.exp(a*Math.log(2))/(2*Math.PI))+Math.exp(a*Math.log(2))*(this.TILESIZE/2);return Math.floor(d)},b.prototype.lonToXPixels=function(a,b){var c=b*this.TILESIZE*Math.exp(a*Math.log(2))/(2*Math.PI)+Math.exp(a*Math.log(2))*(this.TILESIZE/2);return Math.floor(c)},b.prototype.getEarthRadiusAtZoomLevel=function(a){var b=this.getCircumference(a);return b/(2*Math.PI)},b.prototype.getCircumference=function(a){var b=Math.pow(2,a),c=b;return c},b.prototype.xPixelToLon=function(a,b){var c=(b-Math.exp(a*Math.log(2))*(this.TILESIZE/2))*2*Math.PI/(this.TILESIZE*Math.exp(a*Math.log(2)));return c},b.prototype.yPixelToLat=function(a,b){var c=-(b-Math.exp(a*Math.log(2))*(this.TILESIZE/2))*2*Math.PI/(this.TILESIZE*Math.exp(a*Math.log(2))),d=Math.atan(this.tanh(c));return d},b.prototype.atanh=function(a){return.5*Math.log((1+a)/(1-a))},b.prototype.tanh=function(a){return(Math.exp(2*a)-1)/(Math.exp(2*a)+1)},b.prototype.degreesToRadians=function(a){return a*Math.PI/180},b.prototype.radiansToDegrees=function(a){return a*180/Math.PI},b.prototype.within=function(a,b,c){return Math.abs(a-b)<c},a.exports=b})(),provide("tolmey",a.exports),$.ender(a.exports)}(),!function(){var a={exports:{}},b=a.exports;
/*!
